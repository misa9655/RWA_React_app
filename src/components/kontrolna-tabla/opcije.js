                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-3">
                                <NavLink to="/panel/newPost" className="btn btn-primary btn-block">
                                    <i className="fa fa-plus"></i> Novi post
                                </NavLink>
                            </div>
                            <div className="col-md-3">
                                <NavLink to="/panel/newCategory" className="btn btn-success btn-block">
                                    <i className="fa fa-plus"></i> Dodaj kategoriju
                                </NavLink>
                            </div>
                            <div className="col-md-3">
                                <NavLink to="/panel/newUser" className="btn btn-warning btn-block text-white">
